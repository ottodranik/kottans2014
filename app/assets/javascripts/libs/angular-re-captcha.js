    ...
    return {
        ...
        link: function(scope, element, attrs, controller) {
            ...
            reCAPTCHA.create(element[0], function() {
                ...
                $compile(angular.element(document.querySelector('input#recaptcha_response_field')).attr('placehold', true))(scope);
                $compile(angular.element(document.querySelector('input#recaptcha_response_field')).attr('placeholder', 'ВВЕДИ ТЕКСТ'))(scope);
